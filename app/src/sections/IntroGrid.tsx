      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16 md:mb-24">
          <div className="mb-6">
            <div className="overflow-hidden">
              ...
              >
                <span className="block text-3xl md:text-4xl lg:text-5xl font-sans font-bold text-[#504a3a] tracking-tight">
            ...
            <div className="overflow-hidden">
              <div
                ...
                className="translate-y-[110%]"
              >
                <span className="block text-3xl md:text-4xl lg:text-5xl font-serif italic font-normal text-[#504a3a]/70">
          ...
          <p
            ref={textRef}
            className="text-base md:text-lg text-[#504a3a]/60 font-body leading-relaxed opacity-0"
          >
        ...
        {introGridConfig.accentText && (
          <div className="mt-12 md:mt-16 flex justify-end">
            <p className="text-sm text-[#504a3a]/40 font-body tracking-wider uppercase">
              {introGridConfig.accentText}
            </p>
          </div>
        )}
